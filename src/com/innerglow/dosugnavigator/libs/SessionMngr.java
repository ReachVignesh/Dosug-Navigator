package com.innerglow.dosugnavigator.libs;

import android.content.Context;
import android.content.Intent;
import android.content.SharedPreferences;
import android.preference.PreferenceManager;
import com.innerglow.dosugnavigator.AgeValidationActivity;
import com.innerglow.dosugnavigator.HomeActivity;
    ...
    public boolean IsLoggedIn(){
		if(prefs.getInt("uid", 0) == 0){
            ...
            if(prefs.getInt("Intro",0)==0){
                Intent i = new Intent(_cntx, AgeValidationActivity.class);
                i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                _cntx.startActivity(i);
                return false;
            }   else {

                Intent i = new Intent(_cntx, HomeActivity.class);
                i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                _cntx.startActivity(i);
                return false;
            }
